...
export const LEGACY_BILL_LOCATION_CATALOG: BillLocationEntry[] = [
  ...
  { city: 'GUARNE', address: 'APTO GUARNE 407', businessGroup: 'WACONDA S.A.S.' },
  { city: 'GUARNE', address: 'APTO GUARNE 603', businessGroup: 'WACONDA S.A.S.' },
  { city: 'GUARNE', address: 'CASA LOTE GUARNE', businessGroup: 'WACONDA S.A.S.' },
...
export const getBillLocationBusinessGroups = (
  _city: string,
  _catalog: BillLocationEntry[] = []
): string[] => [...STANDARD_BILL_BUSINESS_GROUPS];
