...
export interface Site {
  ...
  air_conditioners_count?: number;
  water_tanks_count?: number;
  water_pumps_count?: number;
  rci_pumps_count?: number;
  electrical_plants_count?: number;
  characteristics?: string;
  photos_urls?: string[];
  blueprint_urls?: string[];
  network_info?: { description?: string } | string | null;
  site_history?: unknown;
  cut_pdf_urls?: string[];
  created_by: string;
  created_at: string;
  updated_at: string;
